...
You now have a web app called **Guideline RAG Assistant** for Computer System
Validation documents.

It can:

- read Computer System Validation guideline files
...
## Step 1: Put Validation Files In One Google Drive Folder

1. Open [Google Drive](https://drive.google.com).
2. Click **New**.
3. Click **Folder**.
4. Name it something like `Computer System Validation Guidelines`.
5. Upload your validation files into this folder.
...
1. Open the app.
2. In the left panel, click **Upload CSV validation files**.
3. Select one or more validation files.
